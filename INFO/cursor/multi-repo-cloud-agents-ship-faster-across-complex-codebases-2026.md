# Multi-Repo Cloud Agents: Ship Faster Across Complex Codebases

**Speaker(s):** Cursor Technical Team · **Channel:** Cursor · **Date:** 2026-06-03
**Watch:** https://youtu.be/CcWeYfC4Xns · **Format:** Workshop · **Level:** Intermediate
**Topics:** AI Agents, AI Coding Tools

## TL;DR
This session explores multi-repo cloud agents: ship faster across complex codebases, highlighting core architecture, runtime workflows, and practical deployment patterns across AI Agents, AI Coding Tools. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor, Cursor Agent.

## Contents
- [Core Concepts and Architectural Foundations of Multi-Repo Cloud Agents: Ship Faster Across Complex Codebases](#core-concepts-and-architectural-foundations-of-multi-repo-cloud-agents-ship-faster-across-complex-codebases)
...
## Source
Full cleaned transcript: `DATA/videos/multi-repo-cloud-agents-ship-faster-across-complex-codebases-2026.json`
Canonical recording: https://youtu.be/CcWeYfC4Xns