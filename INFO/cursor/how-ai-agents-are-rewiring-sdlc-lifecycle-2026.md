# How AI Agents are Rewiring the SDLC - Lifecycle Transformation

**Speaker(s):** Jack Clary · **Channel:** Cursor · **Date:** 2026-06-03
**Watch:** https://youtu.be/_vi4x0vqxLk · **Format:** Workshop · **Level:** Intermediate
**Topics:** AI Agents, AI Coding Tools

## TL;DR
This session explores how ai agents are rewiring the sdlc - lifecycle transformation, highlighting core architecture, runtime workflows, and practical deployment patterns across AI Agents, AI Coding Tools. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor, Cursor Agent.

## Contents
- [Core Concepts and Architectural Foundations of How AI Agents are Rewiring the SDLC - Lifecycle Transformation](#core-concepts-and-architectural-foundations-of-how-ai-agents-are-rewiring-the-sdlc-lifecycle-transformation)
...
## Source
Full cleaned transcript: `DATA/videos/how-ai-agents-are-rewiring-sdlc-lifecycle-2026.json`
Canonical recording: https://youtu.be/_vi4x0vqxLk