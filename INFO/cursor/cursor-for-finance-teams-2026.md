...
**Speaker(s):** Will · **Channel:** Cursor · **Date:** 2026-05-29
**Watch:** https://youtu.be/ZsfRI6SMuzc · **Format:** Workshop · **Level:** Advanced
**Topics:** AI Coding Tools, Product/Startup, AI Agents

## TL;DR
This session explores cursor for finance teams, highlighting core architecture, runtime workflows, and practical deployment patterns across AI Coding Tools, Product/Startup, AI Agents. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor, Slack.

## Contents
- [Core Concepts and Architectural Foundations of Cursor for Finance Teams](#core-concepts-and-architectural-foundations-of-cursor-for-finance-teams)
...
## Source
Full cleaned transcript: `DATA/videos/cursor-for-finance-teams-2026.json`
Canonical recording: https://youtu.be/ZsfRI6SMuzc