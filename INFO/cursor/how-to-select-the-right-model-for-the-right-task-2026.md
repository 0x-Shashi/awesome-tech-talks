...
**Speaker(s):** Santi · **Channel:** Cursor · **Date:** 2026-06-30
**Watch:** https://youtu.be/QsLF3UhQ89Q · **Format:** Workshop · **Level:** Beginner
**Topics:** LLM Fundamentals, Prompt Engineering, AI Coding Tools

## TL;DR
This session explores how to select the right model for the right task, highlighting core architecture, runtime workflows, and practical deployment patterns across LLM Fundamentals, Prompt Engineering, AI Coding Tools. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor, Cursor Agent.

## Contents
- [Core Concepts and Architectural Foundations of How to select the right model for the right task](#core-concepts-and-architectural-foundations-of-how-to-select-the-right-model-for-the-right-task)
...
## Source
Full cleaned transcript: `DATA/videos/how-to-select-the-right-model-for-the-right-task-2026.json`
Canonical recording: https://youtu.be/QsLF3UhQ89Q