# Model Selection and Token Efficiency - Token Economics and Model Choice

**Speaker(s):** Santi Garza · **Channel:** Cursor · **Date:** 2026-09-04
**Watch:** https://youtu.be/KcshxSB3sNY · **Format:** Workshop · **Level:** Intermediate
**Topics:** LLM Fundamentals, Prompt Engineering, AI Coding Tools

## TL;DR
This session explores model selection and token efficiency - token economics and model choice, highlighting core architecture, runtime workflows, and practical deployment patterns across LLM Fundamentals, Prompt Engineering, AI Coding Tools. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor, Cursor Agent.

## Contents
- [Core Concepts and Architectural Foundations of Model Selection and Token Efficiency - Token Economics and Model Choice](#core-concepts-and-architectural-foundations-of-model-selection-and-token-efficiency-token-economics-and-model-choice)
...
## Source
Full cleaned transcript: `DATA/videos/model-selection-token-economics-2026.json`
Canonical recording: https://youtu.be/KcshxSB3sNY