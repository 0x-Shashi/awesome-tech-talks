...
**Speaker(s):** Nate Umoff · **Channel:** Cursor · **Date:** 2026-02-24
**Watch:** https://youtu.be/SeAQUJ_QO_Y · **Format:** Talk · **Level:** Advanced
**Topics:** AI Coding Tools, AI Agents

## TL;DR
This session explores securing agentic coding at scale, highlighting core architecture, runtime workflows, and practical deployment patterns across AI Coding Tools, AI Agents. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor, Cursor Agent.

## Contents
- [Core Concepts and Architectural Foundations of Securing Agentic Coding at Scale](#core-concepts-and-architectural-foundations-of-securing-agentic-coding-at-scale)
...
Diving deeper into operational mechanics, the presentation details how specific platform capabilities interact to execute complex programming tasks. Key components such as Cursor, Cursor Agent, Cursor Tab work in concert to maintain project state and navigate intricate dependency graphs. The session highlights the importance of deterministic tool calling, background agent execution, and structured feedback loops. Developers are guided through concrete demonstrations showing how natural language prompts are parsed into multi-file diffs, verified against local unit tests, and iteratively refined before final commit. This pattern ensures high reliability across both legacy refactoring and greenfield service development.
...
## Source
Full cleaned transcript: `DATA/videos/securing-agentic-coding-at-scale-2026.json`
Canonical recording: https://youtu.be/SeAQUJ_QO_Y