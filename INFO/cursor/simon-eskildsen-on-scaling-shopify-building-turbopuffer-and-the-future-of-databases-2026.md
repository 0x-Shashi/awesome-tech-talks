...
**Speaker(s):** Simon Eskildsen, Aman Sanger · **Channel:** Cursor · **Date:** 2026-05-14
**Watch:** https://youtu.be/bWyOyyrVIXk · **Format:** Fireside Chat · **Level:** Advanced
**Topics:** Backend/Infra, AI Coding Tools, AI Agents

## TL;DR
This session explores simon eskildsen on scaling shopify, building turbopuffer, and the future of databases, highlighting core architecture, runtime workflows, and practical deployment patterns across Backend/Infra, AI Coding Tools, AI Agents. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor, Turbopuffer.

## Contents
- [Core Concepts and Architectural Foundations of Simon Eskildsen on scaling Shopify, building turbopuffer, and the future of databases](#core-concepts-and-architectural-foundations-of-simon-eskildsen-on-scaling-shopify-building-turbopuffer-and-the-future-of-databases)
...
Diving deeper into operational mechanics, the presentation details how specific platform capabilities interact to execute complex programming tasks. Key components such as Cursor, Turbopuffer, GitHub work in concert to maintain project state and navigate intricate dependency graphs. The session highlights the importance of deterministic tool calling, background agent execution, and structured feedback loops. Developers are guided through concrete demonstrations showing how natural language prompts are parsed into multi-file diffs, verified against local unit tests, and iteratively refined before final commit. This pattern ensures high reliability across both legacy refactoring and greenfield service development.
...
## Source
Full cleaned transcript: `DATA/videos/simon-eskildsen-on-scaling-shopify-building-turbopuffer-and-the-future-of-databases-2026.json`
Canonical recording: https://youtu.be/bWyOyyrVIXk