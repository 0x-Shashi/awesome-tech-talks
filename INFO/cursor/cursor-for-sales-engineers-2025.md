...
**Speaker(s):** Mark · **Channel:** Cursor · **Date:** 2025-11-18
**Watch:** https://youtu.be/vEFrgXkyfE0 · **Format:** Demo · **Level:** Intermediate
**Topics:** AI Coding Tools, Web Development, AI Agents

## TL;DR
This session explores cursor for sales engineers, highlighting core architecture, runtime workflows, and practical deployment patterns across AI Coding Tools, Web Development, AI Agents. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor, Slack.

## Contents
- [Core Concepts and Architectural Foundations of Cursor for Sales Engineers](#core-concepts-and-architectural-foundations-of-cursor-for-sales-engineers)
...
## Source
Full cleaned transcript: `DATA/videos/cursor-for-sales-engineers-2025.json`
Canonical recording: https://youtu.be/vEFrgXkyfE0