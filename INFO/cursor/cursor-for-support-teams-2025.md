...
**Speaker(s):** Cursor Technical Team · **Channel:** Cursor · **Date:** 2025-11-18
**Watch:** https://youtu.be/970PIrK0MWo · **Format:** Workshop · **Level:** Intermediate
**Topics:** Product/Startup, AI Coding Tools, AI Agents

## TL;DR
This session explores cursor for support teams, highlighting core architecture, runtime workflows, and practical deployment patterns across Product/Startup, AI Coding Tools, AI Agents. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor.

## Contents
- [Core Concepts and Architectural Foundations of Cursor for Support Teams](#core-concepts-and-architectural-foundations-of-cursor-for-support-teams)
...
## Source
Full cleaned transcript: `DATA/videos/cursor-for-support-teams-2025.json`
Canonical recording: https://youtu.be/970PIrK0MWo