# Coding Agents and the Future of Engineering

**Speaker(s):** Joseph · **Channel:** Cursor · **Date:** 2026-06-10
**Watch:** https://youtu.be/M3mAb-E0gtc · **Format:** Workshop · **Level:** Intermediate
**Topics:** AI Agents, AI Coding Tools

## TL;DR
This session explores coding agents and the future of engineering, highlighting core architecture, runtime workflows, and practical deployment patterns across AI Agents, AI Coding Tools. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor, Cursor Agent.

## Contents
- [Core Concepts and Architectural Foundations of Coding Agents and the Future of Engineering](#core-concepts-and-architectural-foundations-of-coding-agents-and-the-future-of-engineering)
...
## Source
Full cleaned transcript: `DATA/videos/coding-agents-and-the-future-of-engineering-2026.json`
Canonical recording: https://youtu.be/M3mAb-E0gtc