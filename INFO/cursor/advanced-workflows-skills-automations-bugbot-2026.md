# Advanced Workflows: Skills, Automations, Subagents, and Bugbot

**Speaker(s):** Cursor Technical Team · **Channel:** Cursor · **Date:** 2026-07-07
**Watch:** https://youtu.be/l1Ly5NsIpQg · **Format:** Workshop · **Level:** Intermediate
**Topics:** AI Agents, AI Coding Tools

## TL;DR
This session explores advanced workflows: skills, automations, subagents, and bugbot, highlighting core architecture, runtime workflows, and practical deployment patterns across AI Agents, AI Coding Tools. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor, Cursor CLI.

## Contents
- [Core Concepts and Architectural Foundations of Advanced Workflows: Skills, Automations, Subagents, and Bugbot](#core-concepts-and-architectural-foundations-of-advanced-workflows-skills-automations-subagents-and-bugbot)
...
Diving deeper into operational mechanics, the presentation details how specific platform capabilities interact to execute complex programming tasks. Key components such as Cursor, Cursor CLI, Bugbot work in concert to maintain project state and navigate intricate dependency graphs. The session highlights the importance of deterministic tool calling, background agent execution, and structured feedback loops. Developers are guided through concrete demonstrations showing how natural language prompts are parsed into multi-file diffs, verified against local unit tests, and iteratively refined before final commit. This pattern ensures high reliability across both legacy refactoring and greenfield service development.
...
## Source
Full cleaned transcript: `DATA/videos/advanced-workflows-skills-automations-bugbot-2026.json`
Canonical recording: https://youtu.be/l1Ly5NsIpQg