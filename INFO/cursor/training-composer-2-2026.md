...
**Watch:** https://youtu.be/uTgqYeVxy2c · **Format:** Workshop · **Level:** Advanced
**Topics:** LLM Fundamentals, AI Coding Tools, AI Agents

## TL;DR
This session explores training composer 2, highlighting core architecture, runtime workflows, and practical deployment patterns across LLM Fundamentals, AI Coding Tools, AI Agents. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor, Cursor Agent.

## Contents
- [Core Concepts and Architectural Foundations of Training Composer 2](#core-concepts-and-architectural-foundations-of-training-composer-2)
...
## Source
Full cleaned transcript: `DATA/videos/training-composer-2-2026.json`
Canonical recording: https://youtu.be/uTgqYeVxy2c