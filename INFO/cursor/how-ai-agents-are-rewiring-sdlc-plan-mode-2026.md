# How AI Agents are Rewiring the SDLC - Plan Mode and Agent Loops

**Speaker(s):** Evette · **Channel:** Cursor · **Date:** 2026-09-04
**Watch:** https://youtu.be/c0JjmzmWLkg · **Format:** Workshop · **Level:** Intermediate
**Topics:** AI Agents, AI Coding Tools

## TL;DR
This session explores how ai agents are rewiring the sdlc - plan mode and agent loops, highlighting core architecture, runtime workflows, and practical deployment patterns across AI Agents, AI Coding Tools. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor, Bugbot.

## Contents
- [Core Concepts and Architectural Foundations of How AI Agents are Rewiring the SDLC - Plan Mode and Agent Loops](#core-concepts-and-architectural-foundations-of-how-ai-agents-are-rewiring-the-sdlc-plan-mode-and-agent-loops)
...
Diving deeper into operational mechanics, the presentation details how specific platform capabilities interact to execute complex programming tasks. Key components such as Cursor, Bugbot, VS Code work in concert to maintain project state and navigate intricate dependency graphs. The session highlights the importance of deterministic tool calling, background agent execution, and structured feedback loops. Developers are guided through concrete demonstrations showing how natural language prompts are parsed into multi-file diffs, verified against local unit tests, and iteratively refined before final commit. This pattern ensures high reliability across both legacy refactoring and greenfield service development.
...
## Source
Full cleaned transcript: `DATA/videos/how-ai-agents-are-rewiring-sdlc-plan-mode-2026.json`
Canonical recording: https://youtu.be/c0JjmzmWLkg