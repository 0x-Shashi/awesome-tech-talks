...
**Speaker(s):** David Shah · **Channel:** Cursor · **Date:** 2026-02-06
**Watch:** https://youtu.be/7TBFf-z9Co4 · **Format:** Demo · **Level:** Intermediate
**Topics:** AI Coding Tools, AI Agents

## TL;DR
This session explores cursor for financial services, highlighting core architecture, runtime workflows, and practical deployment patterns across AI Coding Tools, AI Agents. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor, Bugbot.

## Contents
- [Core Concepts and Architectural Foundations of Cursor for Financial Services](#core-concepts-and-architectural-foundations-of-cursor-for-financial-services)
...
## Source
Full cleaned transcript: `DATA/videos/cursor-for-financial-services-2026.json`
Canonical recording: https://youtu.be/7TBFf-z9Co4