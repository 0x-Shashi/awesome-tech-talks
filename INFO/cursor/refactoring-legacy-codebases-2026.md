...
**Watch:** https://youtu.be/kMcL9RKXWYo · **Format:** Workshop · **Level:** Advanced
**Topics:** AI Agents, AI Coding Tools

## TL;DR
This session explores refactoring legacy codebases, highlighting core architecture, runtime workflows, and practical deployment patterns across AI Agents, AI Coding Tools. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor, Cursor Agent.

## Contents
- [Core Concepts and Architectural Foundations of Refactoring Legacy Codebases](#core-concepts-and-architectural-foundations-of-refactoring-legacy-codebases)
...
## Source
Full cleaned transcript: `DATA/videos/refactoring-legacy-codebases-2026.json`
Canonical recording: https://youtu.be/kMcL9RKXWYo