...
**Speaker(s):** John Schulman, Michael Truell · **Channel:** Cursor · **Date:** 2025-12-18
**Watch:** https://youtu.be/29BYxvvF1iM · **Format:** Fireside Chat · **Level:** Advanced
**Topics:** LLM Fundamentals, Research/Papers, AI Coding Tools

## TL;DR
This session explores john schulman on dead ends, scaling rl, and building research institutions, highlighting core architecture, runtime workflows, and practical deployment patterns across LLM Fundamentals, Research/Papers, AI Coding Tools. Speakers analyze technical implementations and share operational best practices for building robust systems with Cursor, OpenAI.

## Contents
- [Core Concepts and Architectural Foundations of John Schulman on dead ends, scaling RL, and building research institutions](#core-concepts-and-architectural-foundations-of-john-schulman-on-dead-ends-scaling-rl-and-building-research-institutions)
...
Diving deeper into operational mechanics, the presentation details how specific platform capabilities interact to execute complex programming tasks. Key components such as Cursor, OpenAI work in concert to maintain project state and navigate intricate dependency graphs. The session highlights the importance of deterministic tool calling, background agent execution, and structured feedback loops. Developers are guided through concrete demonstrations showing how natural language prompts are parsed into multi-file diffs, verified against local unit tests, and iteratively refined before final commit. This pattern ensures high reliability across both legacy refactoring and greenfield service development.
...
## Source
Full cleaned transcript: `DATA/videos/john-schulman-on-dead-ends-scaling-rl-and-building-research-institutions-2025.json`
Canonical recording: https://youtu.be/29BYxvvF1iM